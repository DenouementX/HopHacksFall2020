...
buttons = ['Clap', 'Thumbs Up', 'Heart', 'Joy', 'Tada']  # Open Mouth was deemed not a good emoji...


def zoom_function_wrap(gesture_id):
    if gesture_id < 5:
        ...
        pass  # This starts live transcription, called elsewhere, so as to avoid sharing unnecessary state
    elif gesture_id == 8:
